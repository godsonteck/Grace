...
import { Mail, MapPin, ShieldCheck, Phone, Map, ArrowRight } from "lucide-react";
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-8 rounded-[40px] bg-slate-900 text-white relative overflow-hidden group shadow-2xl">
                     ...
                     <div className="space-y-8 relative z-10">
                        <div className="flex items-center gap-6">
                           ...
                           <div>
                              <p className="text-[10px] font-black uppercase tracking-widest text-white/60 mb-1">Central Contact</p>
                              <p className="text-xl font-black italic tracking-tighter">0555 777 333</p>
                           </div>
                        </div>
                        <div className="flex items-center gap-6">
                           ...
                           <div>
                              ...
                              <p className="text-xl font-black italic tracking-tighter">gracediagnosticgh@gmail.com</p>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="p-8 rounded-[40px] bg-primary text-white relative overflow-hidden group shadow-2xl shadow-primary/20">
                     ...
                     <div className="relative z-10">
                        ...
                        <h3 className="text-2xl font-black italic uppercase tracking-tighter">Main HQ</h3>
                        <p className="text-[10px] font-black uppercase tracking-widest text-white/70 mt-4 leading-relaxed">
                          Tantra Hills Roundabout,<br/>
                          211 Mushroom Street,<br/>
                          Accra, Ghana
                        </p>
                     </div>
                  </div>
